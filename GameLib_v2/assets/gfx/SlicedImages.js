...
var Slice9 = stampit.props({
	...
	attach : function(parent,x,y,w,h,sliceData) {
		this.target = parent;
		//console.log(img);
	...
	tick : function(){}, //placeholder, subject for removal
	draw : function(){
	...
	createSliceRegions : function(width,height,margins) {
		var w1 = width - 1;
		var h1 = height - 1;
		var top = margins.top;
...
QualityCatGameLibrary.attachModule(Slice9,"Slice9");})();