(function(){
"use strict";
var InputManager = stampit.deepProps({
	keyStates : {},
	mouseState : {},
	parent : {}
}).props({
	...
	checkKeyDown : function(keyID,keyName) {
		var out = false;
	...
	checkKeyPress : function(keyID,keyName) {
		var out = false;
...
QualityCatGameLibrary.attachModule(InputManager,"Input");
})();