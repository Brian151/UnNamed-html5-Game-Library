...
*/
"use strict";
var BitFieldReader = stampit.staticProps({
	masks : [ // masks for reading/toggling bits
		0b10000000,
		0b01000000,
		0b00100000,
		0b00010000,
	...
	masks2 : [ // masks for copying all non-targeted bits
		0b01111111
		0b10111111
		0b11011111
		0b11101111
	...
	shifts : [7,6,5,4,3,2,1,0] // how much to bitwise shift to read the specified bit
}).statics({
	readFlag : function(field,flag){
		var out = (field & this.masks[flag - 1]) >> this.shifts[flag - 1];
		return out;
	},
	toggleFlag : function(field,flag){
	...
	boolToBit : function(bool){
		var out = 0b00000000;
		if (bool > 0) out = 0b00000001;
		return out;
	},
	fieldToBooleanArray : function(){
		var out = [];
...
QualityCatGameLibrary.attachModule(BitFieldReader,"BitfieldTool");
})();